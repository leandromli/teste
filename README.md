...
<body style="background-color: rgb(3, 3, 15);">
     
    <h1 style="font-size: 33pt; color: rgb(11, 5, 95); " </h1>HOMEM ARANHA &copy;</h1> 
   
      </centrol>
    <h2 style="color:rgb(233, 13, 13);"> Bom tá aqui!</h2>
    <hr = spPropContainer color = "blue">
    <h3 style="color:blanchedalmond">Vamos lá!</h3>
    <h5 style="color:blanchedalmond"aria-controls=" Homem Aranha">Eu sou o HOMEM ARANHA, e vou falar um pouco sobre mim!
    </h5>
    <h3 style="color:blanchedalmond">Stan Lee, foi o meu criador , "Meu Pai".</h3>
    <hr = spPropContainer color="red" >
    
    <img src= "https://i.pinimg.com/originals/22/d7/0d/22d70db52e62842c4da6c4b93ddcffa5.png" title = " HOMEM ARANHA" alt="HOMEM ARANHA">

    <h3 style="color:blanchedalmond">Minhas varias formas</h3>
    ...
    <h2 style="color:blanchedalmond">Stan Lee, criador de heróis da Marvel, morre aos 95 anos</h2>
    <h4 style="color:blanchedalmond">Quadrinista participou da criação de super-heróis icônicos como <BR></BR> Homem-Aranha, Thor, Hulk, X-Men, Pantera Negra, Demolidor, Homem de Ferro e Quarteto Fantástico.</h4>
     <img src="https://i.makeagif.com/media/9-15-2015/GU4G_b.gif" alt="">
     <hr = spPropContainer color = "red">
     <img src="https://www.imagensanimadas.com/data/media/1555/homem-aranha-imagem-animada-0018.gif" alt="homem-aranha-imagem-animada-0018">
     <hr = spPropContainer color = "red">>
     <img src="https://img.elo7.com.br/product/zoom/181A987/adesivo-para-notebook-homem-aranha-skin-para-notebook.jpg" alt="">
...
<a segui o link hret= "https://api.whatsapp.com/send?phone5588996411010&text=Texto%20aqui"
target="black"
